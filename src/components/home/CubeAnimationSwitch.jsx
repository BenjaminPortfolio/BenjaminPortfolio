import styles from "./CubeAnimationSwitch.module.css";
 ...
 * Controls whether the rotating map cube animates.
 *
 * Props:
 *   checked  - whether cube animation is currently enabled
 *   onChange - (nextChecked: boolean) => void
 */
export default function CubeAnimationSwitch({ checked, onChange, position }) {
  return (
