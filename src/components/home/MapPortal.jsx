import "./MapPortalAnim.css";
import styles from "./MapPortal.module.css";

/**
 * MapPortal
 *
 * Uiverse.io animated "server" graphic (by Juanes200122) with floating
 * particles. Rendered as a floating element on the right side of the map.
 *
 * Props:
 *   position - optional CSS style object merged onto the .float wrapper,
 *              so callers can control placement per viewport.
 */
export default function MapPortal({ position }) {
  return (
      ...
      >
        ...
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" y2="92.0933" x2="92.5421" y1="92.0933" x1="1.00946" id="paint0_linear_204_217">
            <stop stopColor="#4a80b8" />
            <stop stopColor="#6fa8c9" offset={1} />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" y2="91.1638" x2="6.72169" y1={70} x1="92.5" id="paint1_linear_204_217">
            <stop stopColor="#6fa8c9" />
            <stop stopColor="#3a4a5c" offset="0.29" />
            <stop stopColor="#4a80b8" offset={1} />
          </linearGradient>
